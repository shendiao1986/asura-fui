...
public class PageFilesListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		String pages_directory = StaticCacheService.getSettingProperty("page_directory") == null ? "/pages"
				: StaticCacheService.getSettingProperty("page_directory");
		System.out.println("Configured page directory is: " + pages_directory);
		int timeout = Integer.parseInt(StaticCacheService.getSettingProperty("page_timeout") == null ? "10"
				: StaticCacheService.getSettingProperty("page_timeout"));
		initialize(pages_directory, timeout);
		// String pages_path =
		// this.getClass().getClassLoader().getResource(pages_directory).getPath();
		// System.out.println("Start watch page directory:" +
		// pages_path.substring(1));
